    ...
    pages: [
      {
        ...
        sections: [
          ...
          { id: id(), type: 'horizontal_bar', title: 'Top 10 by Origin', width: 'third', height: 'lg', config: { xAxis: 'count', yAxis: 'origin', limit: 10, sort: 'desc' } },
          { id: id(), type: 'horizontal_bar', title: 'Top 10 by Feedback Origin', width: 'third', height: 'lg', config: { xAxis: 'count', yAxis: 'origin', filter: 'sla_h0_h1', limit: 10 } },
          { id: id(), type: 'horizontal_bar', title: 'Top 10 by Customer', width: 'third', height: 'lg', config: { xAxis: 'count', yAxis: 'customer', limit: 10, sort: 'desc' } },
